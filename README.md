...
1.) The first thing you are going to want to do is create a virtual machine by going to https://portal.azure.com/ and once you are on the portal page search at the top for virtual machine. Setup your virtual machine with Windows 10 Pro, version 22H2. Note, you will want to create a virtual machine with atleast 2 vcpus and 16 gbs of memory.

2.) Once you have created your virtual machine you will connect to it by using the public ip address the vm is setup with. After that you will connect using the remote desktop connection app. 
</p>
<br />
...
3.) Once you have connected to your virtual machine you will go to your control panel. From the control panel open up programs. Select, Turn Windows features on and off.
...
4.) You will install / enable IIS in Windows with CGI and Common HTTP Features
...
11.) Now that the files are downloaded and installed search for IIS in the windows search bar. Open IIS as an administrator.
...
15.) Once those extensions are enabled in IIS rename one of the files in our osTicket folder.
  Go into the file explorer and search for C;\inetpub\wwwroot\osTicket\include\ost-sampleconfig.php
  
  We are going to rename the ost-sampleconfig.php to ost-config.php
  
  Now that the files have been renamed, right click on the file and go to properties.
...
After that is completed please continue to setup osTicket in the browser. Click Continue on the osTicket browser page.
...
<p>
   ...
   To  complete this part of the installation please delete the setup folder in our system. 
  -Delete: C:\inetpub\wwwroot\osTicket\setup
  Setup folder is the only folder that should be deleted.
...
<p>
 ...
 All steps are comeplete and you have now setup osTicket.
